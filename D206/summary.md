...
The research question for this project was "Which types of customers are more likely to terminate their services?" My report for this assignment can be found [here](https://github.com/hillaryosei/MSDA_Portfolio/blob/main/D206/d206-task1.pdf) and the code can be found [here](https://github.com/hillaryosei/MSDA_Portfolio/blob/main/D206/d206.ipynb).
