...
The research question I addressed in this project is "Which types of customers are more likely to terminate their services?" My report for this assignement can be found [here](https://github.com/hillaryosei/MSDA_Portfolio/blob/main/D206/d206-task1.pdf) and the code can be found [here](https://github.com/hillaryosei/MSDA_Portfolio/blob/main/D206/d206.ipynb).
